...
const comps = {
  de: (
    <>
      ...
      <Typography>Datenstand Januar 2026</Typography>
    </>
  ),
  fr: (
    <>
      ...
      <Typography>État des données janvier 2026</Typography>
    </>
  ),
  it: (
    <>
      ...
      <Typography>Aggiornamento dei dati gennaio 2026</Typography>
    </>
  ),
  en: (
    <>
      ...
      <Typography>Data status January 2026</Typography>
    </>
  ),
};
