...
const comps = {
  de: (
    <>
      ...
      <Typography>Datenstand Juni 2026</Typography>
    </>
  ),
  fr: (
    <>
      ...
      <Typography>État des données juin 2026</Typography>
    </>
  ),
  it: (
    <>
      ...
      <Typography>Aggiornamento dei dati giugno 2026</Typography>
    </>
  ),
  en: (
    <>
      ...
      <Typography>Data status June 2026</Typography>
    </>
  ),
};
