...
export const getStsLayers = () => {
  ...
  const highlightRoutes = new HighlightRoutesLayer({
  ...
  const otherRoutes = new MapboxStyleLayer({
    name: "Other routes",
    key: OTHER_LAYER_KEY,
    mapboxLayer: stsValidityDataLayer,
    visible: true,
  ...
  const gttos = new MapboxStyleLayer({
  ...
  const stsDvMain = new DirektverbindungenLayer({
    visible: false,
    name: `${DV_KEY}.main`,
    key: `${DV_KEY}.main`,
    mapboxLayer: stsDirektverbindungenDataLayer,
