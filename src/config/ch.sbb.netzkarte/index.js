...
export const getNetzkarteLayers = () => {
  ...
  const netzkarteLayer = new MapboxStyleLayer({
    name: NETZKARTE_LAYER_NAME,
  ...
  const netzkarteNight = new MapboxStyleLayer({
    name: NETZKARTE_DARK_LAYER_NAME,
  ...
  const netzkarteAerial = new MapboxStyleLayer({
    name: NETZKARTE_AERIAL_LAYER_NAME,
  ...
  const swisstopoLandeskarteGrau = new MapboxStyleLayer({
    name: STOPO_LANDESKARTE_GRAU_LAYER_NAME,
  ...
  const bahnhofplaene = new Layer({
    name: BAHNHOFPLAENE_LAYER_NAME,
    visible: false,
  ...
  const punctuality = new TralisLayer({
  ...
  const stationsLayer = new StationsLayer({
    name: STATIONS_LAYER_NAME,
    mapboxLayer: dataLayer,
  });

  const platformsLayer = new PlatformsLayer({
    name: PLATFORMS_LAYER_NAME,
    mapboxLayer: dataLayer,
  });
  ...
  const gemeindegrenzen = new MapboxStyleLayer({
