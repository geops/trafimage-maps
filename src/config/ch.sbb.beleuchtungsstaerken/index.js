...
export const getBeleuchtungsLayers = () => {
  const beleuchtungDataLayer = new TrafimageMapboxLayer({
  ...
  const beleuchtungstaerken1Layer = new BeleuchtungsLayer({
  ...
  const beleuchtungstaerken2aLayer = new BeleuchtungsLayer({
  ...
  const beleuchtungstaerken2bLayer = new BeleuchtungsLayer({
  ...
  const beleuchtungstaerken3Layer = new BeleuchtungsLayer({
  ...
  const beleuchtungstaerken4Layer = new BeleuchtungsLayer({
  ...
  const beleuchtungstaerkenSchutzgebieteLayer = new MapsGeoAdminLayer({
  ...
  const beleuchtungstaerkenBundesInventareLayer = new MapsGeoAdminLayer({
