...
export const getIsbLayers = () => {
  const netzkarteIsb = new TrafimageMapboxLayer({
    name: "ch.sbb.isb",
    visible: true,
    zIndex: -1,
  ...
  const isbOther = new MapboxStyleLayer({
  ...
  const isbTVS = new MapboxStyleLayer({
    name: "ch.sbb.isb.tvs",
    mapboxLayer: netzkarteIsb,
    styleLayersFilter: ({ metadata }) =>
      metadata &&
  ...
  const isbNormalspurbahnen = new Layer({
  ...
  const isbSchmalspurbahnen = new SchmalspurLayer({
