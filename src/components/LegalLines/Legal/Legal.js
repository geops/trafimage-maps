...
const comps = {
  de: (
    <div className="tm-imprint">
      ...
      <p>
        Keine Garantie der Verfügbarkeit der abgespeicherten Zeichnungen, kein
        Backup, Speicherung nur für 1 Jahr, keine Haftung seitens Betreiber SBB
        für abgespeicherte Daten; Zeichnung kann jederzeit vom Erstellenden
        gelöscht werden; Dritte können auf Zeichnung zugreifen (betrachten und
        kopieren, jedoch nicht verändern); Der Nutzer verpflichtet sich, die zur
        Verfügung stehende Zeichnungsfunktion nicht missbräuchlich zu verwenden
        und rechtswidrige Handlungen zu unterlassen. Datenschutz- und
        urheberrechtliche Vorschriften sind zu beachten; ein Missbrauch wird
        geahndet und kann strafrechtlich verfolgt werden. Insbesondere darf
        Schutz von Privatsphäre / persönlichen Daten nicht verletzt und
        Urheberrechte nicht verletzt werden. Die SBB behält sich vor, solche
        Daten jederzeit ohne Warnung zu löschen.
      </p>
    </div>
  ),
  fr: (
    <div className="tm-imprint">
      ...
      <p>
        Aucune garantie n’est donnée quant à la disponibilité des dessins
        enregistrés, aucun backup n’est réalisé, le stockage est fonctionnel une
        année, aucune responsabilité n’est prise par l’exploitant SBB/CFF/FFS.
        Le dessin peut être en tout temps supprimé par son créateur. Des tiers
        ...
        dessin à tout moment et sans avertissement.
      </p>
    </div>
  ),
  en: (
    <div className="tm-imprint">
      ...
      <p>
        No guarantee for availability of stored drawings, no backup provided,
        storage for 1 year only, no liability of operator SBB/CFF/FFS for stored
        data. Drawing can be deleted anytime by original creator; Third
        parties/public can access drawing (view and copy, but not change). The
        user commits himself not to misuse the provided drawing function and to
        refrain from illegal activities. Privacy and copyright regulations must
        be respected; misuse is punishable and can be prosecuted. In particular,
        protection of privacy , personal data and copyrights must not be
        violated. SBB reserves the right to delete such data at any time without
        warning.
      </p>
    </div>
  ),
  it: (
    <div className="tm-imprint">
      ...
      <p>
        La disponibilità dei disegni salvati non è garantita, nessun backup è
        operato, la memorizzazione dei disegni è limitata ad un anno, alcuna
        responsabilità può essere imputata all’operatore del servizio
        SBB/CFF/FFS. Il disegno può essere eliminato in qualsiasi momento da chi
        lo ha creato. Il disegno è accessibile a terzi (visualizzazione e/o
        copia. Modifica non ammessa). L’utente si impegna a non abusare del
        servizio ed a rinunciare ad un suo utilizzo per pratiche illegali. La
        confidenzialità ed il diritto d’autore devono essere rispettati.
        L’utilizzazione abusiva è punibile e può essere perseguita. In
        particolare, la protezione della sfera privata / dei dati personali deve
        essere conforme alle norme vigenti. SBB/CFF/FFS si riserva il diritto di
        eliminare un disegno in qualsiasi momento e senza avvertimento.
      </p>
    </div>
  ),
};
