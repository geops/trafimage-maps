...
const propTypes = {
  ...
  /**
   * Function triggered when the autocomplete input's clear button gets clicked.
   */
    ...
    return (
      ...
      >
        <SearchInput
          ...
          onClearClick={(e) => onClearClick(e)}
          onClickSearchButton={(e) => this.onSelect(e, items && items[0])}
          ref={(node) => {
